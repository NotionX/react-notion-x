[Docs](../README.md) / [notion-types](../modules/notion_types.md) / CodepenBlock

# Interface: CodepenBlock

[notion-types](../modules/notion_types.md).CodepenBlock
...
- [alive](notion_types.CodepenBlock.md#alive)
- [content](notion_types.CodepenBlock.md#content)
- [created\_by\_id](notion_types.CodepenBlock.md#created_by_id)
- [created\_by\_table](notion_types.CodepenBlock.md#created_by_table)
- [created\_time](notion_types.CodepenBlock.md#created_time)
- [file\_ids](notion_types.CodepenBlock.md#file_ids)
- [format](notion_types.CodepenBlock.md#format)
- [id](notion_types.CodepenBlock.md#id)
- [last\_edited\_by\_id](notion_types.CodepenBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.CodepenBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.CodepenBlock.md#last_edited_time)
- [parent\_id](notion_types.CodepenBlock.md#parent_id)
- [parent\_table](notion_types.CodepenBlock.md#parent_table)
- [properties](notion_types.CodepenBlock.md#properties)
- [space\_id](notion_types.CodepenBlock.md#space_id)
- [type](notion_types.CodepenBlock.md#type)
- [version](notion_types.CodepenBlock.md#version)
...
[packages/notion-types/src/block.ts:296](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L296)
