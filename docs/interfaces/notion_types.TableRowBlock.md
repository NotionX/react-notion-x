[Docs](../README.md) / [notion-types](../modules/notion_types.md) / TableRowBlock

# Interface: TableRowBlock

[notion-types](../modules/notion_types.md).TableRowBlock
...
- [alive](notion_types.TableRowBlock.md#alive)
- [content](notion_types.TableRowBlock.md#content)
- [created\_by\_id](notion_types.TableRowBlock.md#created_by_id)
- [created\_by\_table](notion_types.TableRowBlock.md#created_by_table)
- [created\_time](notion_types.TableRowBlock.md#created_time)
- [format](notion_types.TableRowBlock.md#format)
- [id](notion_types.TableRowBlock.md#id)
- [last\_edited\_by\_id](notion_types.TableRowBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.TableRowBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.TableRowBlock.md#last_edited_time)
- [parent\_id](notion_types.TableRowBlock.md#parent_id)
- [parent\_table](notion_types.TableRowBlock.md#parent_table)
- [properties](notion_types.TableRowBlock.md#properties)
- [space\_id](notion_types.TableRowBlock.md#space_id)
- [type](notion_types.TableRowBlock.md#type)
- [version](notion_types.TableRowBlock.md#version)
...
▪ [column: `string`]: [`Decoration`](../modules/notion_types.md#decoration)[]
...
[packages/notion-types/src/block.ts:440](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L440)
...
[packages/notion-types/src/block.ts:439](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L439)
