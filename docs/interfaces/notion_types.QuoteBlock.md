[Docs](../README.md) / [notion-types](../modules/notion_types.md) / QuoteBlock

# Interface: QuoteBlock

[notion-types](../modules/notion_types.md).QuoteBlock
...
- [alive](notion_types.QuoteBlock.md#alive)
- [content](notion_types.QuoteBlock.md#content)
- [created\_by\_id](notion_types.QuoteBlock.md#created_by_id)
- [created\_by\_table](notion_types.QuoteBlock.md#created_by_table)
- [created\_time](notion_types.QuoteBlock.md#created_time)
- [format](notion_types.QuoteBlock.md#format)
- [id](notion_types.QuoteBlock.md#id)
- [last\_edited\_by\_id](notion_types.QuoteBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.QuoteBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.QuoteBlock.md#last_edited_time)
- [parent\_id](notion_types.QuoteBlock.md#parent_id)
- [parent\_table](notion_types.QuoteBlock.md#parent_table)
- [properties](notion_types.QuoteBlock.md#properties)
- [space\_id](notion_types.QuoteBlock.md#space_id)
- [type](notion_types.QuoteBlock.md#type)
- [version](notion_types.QuoteBlock.md#version)
...
[packages/notion-types/src/block.ts:215](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L215)
