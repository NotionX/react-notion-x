[Docs](../README.md) / [notion-types](../modules/notion_types.md) / ColumnBlock

# Interface: ColumnBlock

[notion-types](../modules/notion_types.md).ColumnBlock
...
- [alive](notion_types.ColumnBlock.md#alive)
- [content](notion_types.ColumnBlock.md#content)
- [created\_by\_id](notion_types.ColumnBlock.md#created_by_id)
- [created\_by\_table](notion_types.ColumnBlock.md#created_by_table)
- [created\_time](notion_types.ColumnBlock.md#created_time)
- [format](notion_types.ColumnBlock.md#format)
- [id](notion_types.ColumnBlock.md#id)
- [last\_edited\_by\_id](notion_types.ColumnBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.ColumnBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.ColumnBlock.md#last_edited_time)
- [parent\_id](notion_types.ColumnBlock.md#parent_id)
- [parent\_table](notion_types.ColumnBlock.md#parent_table)
- [properties](notion_types.ColumnBlock.md#properties)
- [space\_id](notion_types.ColumnBlock.md#space_id)
- [type](notion_types.ColumnBlock.md#type)
- [version](notion_types.ColumnBlock.md#version)
...
[packages/notion-types/src/block.ts:248](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L248)
...
[packages/notion-types/src/block.ts:247](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L247)
