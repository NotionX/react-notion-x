[Docs](../README.md) / [notion-types](../modules/notion_types.md) / TableOfContentsBlock

# Interface: TableOfContentsBlock

[notion-types](../modules/notion_types.md).TableOfContentsBlock
...
- [alive](notion_types.TableOfContentsBlock.md#alive)
- [content](notion_types.TableOfContentsBlock.md#content)
- [created\_by\_id](notion_types.TableOfContentsBlock.md#created_by_id)
- [created\_by\_table](notion_types.TableOfContentsBlock.md#created_by_table)
- [created\_time](notion_types.TableOfContentsBlock.md#created_time)
- [format](notion_types.TableOfContentsBlock.md#format)
- [id](notion_types.TableOfContentsBlock.md#id)
- [last\_edited\_by\_id](notion_types.TableOfContentsBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.TableOfContentsBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.TableOfContentsBlock.md#last_edited_time)
- [parent\_id](notion_types.TableOfContentsBlock.md#parent_id)
- [parent\_table](notion_types.TableOfContentsBlock.md#parent_table)
- [properties](notion_types.TableOfContentsBlock.md#properties)
- [space\_id](notion_types.TableOfContentsBlock.md#space_id)
- [type](notion_types.TableOfContentsBlock.md#type)
- [version](notion_types.TableOfContentsBlock.md#version)
...
[packages/notion-types/src/block.ts:233](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L233)
...
[packages/notion-types/src/block.ts:232](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L232)
