[Docs](../README.md) / [notion-types](../modules/notion_types.md) / FileBlock

# Interface: FileBlock

[notion-types](../modules/notion_types.md).FileBlock
...
- [alive](notion_types.FileBlock.md#alive)
- [content](notion_types.FileBlock.md#content)
- [created\_by\_id](notion_types.FileBlock.md#created_by_id)
- [created\_by\_table](notion_types.FileBlock.md#created_by_table)
- [created\_time](notion_types.FileBlock.md#created_time)
- [file\_ids](notion_types.FileBlock.md#file_ids)
- [format](notion_types.FileBlock.md#format)
- [id](notion_types.FileBlock.md#id)
- [last\_edited\_by\_id](notion_types.FileBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.FileBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.FileBlock.md#last_edited_time)
- [parent\_id](notion_types.FileBlock.md#parent_id)
- [parent\_table](notion_types.FileBlock.md#parent_table)
- [properties](notion_types.FileBlock.md#properties)
- [space\_id](notion_types.FileBlock.md#space_id)
- [type](notion_types.FileBlock.md#type)
- [version](notion_types.FileBlock.md#version)
...
[packages/notion-types/src/block.ts:326](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L326)
...
| Name | Type |
| :------ | :------ |
| `size` | [`Decoration`](../modules/notion_types.md#decoration)[] |
| `source` | `string`[][] |
...
[packages/notion-types/src/block.ts:321](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L321)
...
[packages/notion-types/src/block.ts:320](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L320)
