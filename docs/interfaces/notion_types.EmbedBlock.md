[Docs](../README.md) / [notion-types](../modules/notion_types.md) / EmbedBlock

# Interface: EmbedBlock

[notion-types](../modules/notion_types.md).EmbedBlock
...
- [alive](notion_types.EmbedBlock.md#alive)
- [content](notion_types.EmbedBlock.md#content)
- [created\_by\_id](notion_types.EmbedBlock.md#created_by_id)
- [created\_by\_table](notion_types.EmbedBlock.md#created_by_table)
- [created\_time](notion_types.EmbedBlock.md#created_time)
- [file\_ids](notion_types.EmbedBlock.md#file_ids)
- [format](notion_types.EmbedBlock.md#format)
- [id](notion_types.EmbedBlock.md#id)
- [last\_edited\_by\_id](notion_types.EmbedBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.EmbedBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.EmbedBlock.md#last_edited_time)
- [parent\_id](notion_types.EmbedBlock.md#parent_id)
- [parent\_table](notion_types.EmbedBlock.md#parent_table)
- [properties](notion_types.EmbedBlock.md#properties)
- [space\_id](notion_types.EmbedBlock.md#space_id)
- [type](notion_types.EmbedBlock.md#type)
- [version](notion_types.EmbedBlock.md#version)
...
[packages/notion-types/src/block.ts:276](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L276)
