[Docs](../README.md) / [notion-types](../modules/notion_types.md) / VideoBlock

# Interface: VideoBlock

[notion-types](../modules/notion_types.md).VideoBlock
...
- [alive](notion_types.VideoBlock.md#alive)
- [content](notion_types.VideoBlock.md#content)
- [created\_by\_id](notion_types.VideoBlock.md#created_by_id)
- [created\_by\_table](notion_types.VideoBlock.md#created_by_table)
- [created\_time](notion_types.VideoBlock.md#created_time)
- [file\_ids](notion_types.VideoBlock.md#file_ids)
- [format](notion_types.VideoBlock.md#format)
- [id](notion_types.VideoBlock.md#id)
- [last\_edited\_by\_id](notion_types.VideoBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.VideoBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.VideoBlock.md#last_edited_time)
- [parent\_id](notion_types.VideoBlock.md#parent_id)
- [parent\_table](notion_types.VideoBlock.md#parent_table)
- [properties](notion_types.VideoBlock.md#properties)
- [space\_id](notion_types.VideoBlock.md#space_id)
- [type](notion_types.VideoBlock.md#type)
- [version](notion_types.VideoBlock.md#version)
...
[packages/notion-types/src/block.ts:284](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L284)
