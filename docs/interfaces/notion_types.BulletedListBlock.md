[Docs](../README.md) / [notion-types](../modules/notion_types.md) / BulletedListBlock

# Interface: BulletedListBlock

[notion-types](../modules/notion_types.md).BulletedListBlock
...
- [alive](notion_types.BulletedListBlock.md#alive)
- [content](notion_types.BulletedListBlock.md#content)
- [created\_by\_id](notion_types.BulletedListBlock.md#created_by_id)
- [created\_by\_table](notion_types.BulletedListBlock.md#created_by_table)
- [created\_time](notion_types.BulletedListBlock.md#created_time)
- [format](notion_types.BulletedListBlock.md#format)
- [id](notion_types.BulletedListBlock.md#id)
- [last\_edited\_by\_id](notion_types.BulletedListBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.BulletedListBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.BulletedListBlock.md#last_edited_time)
- [parent\_id](notion_types.BulletedListBlock.md#parent_id)
- [parent\_table](notion_types.BulletedListBlock.md#parent_table)
- [properties](notion_types.BulletedListBlock.md#properties)
- [space\_id](notion_types.BulletedListBlock.md#space_id)
- [type](notion_types.BulletedListBlock.md#type)
- [version](notion_types.BulletedListBlock.md#version)
...
[packages/notion-types/src/block.ts:183](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L183)
