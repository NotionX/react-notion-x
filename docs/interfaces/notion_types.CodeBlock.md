[Docs](../README.md) / [notion-types](../modules/notion_types.md) / CodeBlock

# Interface: CodeBlock

[notion-types](../modules/notion_types.md).CodeBlock
...
- [alive](notion_types.CodeBlock.md#alive)
- [content](notion_types.CodeBlock.md#content)
- [created\_by\_id](notion_types.CodeBlock.md#created_by_id)
- [created\_by\_table](notion_types.CodeBlock.md#created_by_table)
- [created\_time](notion_types.CodeBlock.md#created_time)
- [format](notion_types.CodeBlock.md#format)
- [id](notion_types.CodeBlock.md#id)
- [last\_edited\_by\_id](notion_types.CodeBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.CodeBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.CodeBlock.md#last_edited_time)
- [parent\_id](notion_types.CodeBlock.md#parent_id)
- [parent\_table](notion_types.CodeBlock.md#parent_table)
- [properties](notion_types.CodeBlock.md#properties)
- [space\_id](notion_types.CodeBlock.md#space_id)
- [type](notion_types.CodeBlock.md#type)
- [version](notion_types.CodeBlock.md#version)
...
| `language` | [`Decoration`](../modules/notion_types.md#decoration)[] |
...
[packages/notion-types/src/block.ts:360](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L360)
...
[packages/notion-types/src/block.ts:359](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L359)
