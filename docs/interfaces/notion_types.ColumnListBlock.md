[Docs](../README.md) / [notion-types](../modules/notion_types.md) / ColumnListBlock

# Interface: ColumnListBlock

[notion-types](../modules/notion_types.md).ColumnListBlock
...
- [alive](notion_types.ColumnListBlock.md#alive)
- [content](notion_types.ColumnListBlock.md#content)
- [created\_by\_id](notion_types.ColumnListBlock.md#created_by_id)
- [created\_by\_table](notion_types.ColumnListBlock.md#created_by_table)
- [created\_time](notion_types.ColumnListBlock.md#created_time)
- [format](notion_types.ColumnListBlock.md#format)
- [id](notion_types.ColumnListBlock.md#id)
- [last\_edited\_by\_id](notion_types.ColumnListBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.ColumnListBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.ColumnListBlock.md#last_edited_time)
- [parent\_id](notion_types.ColumnListBlock.md#parent_id)
- [parent\_table](notion_types.ColumnListBlock.md#parent_table)
- [properties](notion_types.ColumnListBlock.md#properties)
- [space\_id](notion_types.ColumnListBlock.md#space_id)
- [type](notion_types.ColumnListBlock.md#type)
- [version](notion_types.ColumnListBlock.md#version)
...
[packages/notion-types/src/block.ts:243](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L243)
