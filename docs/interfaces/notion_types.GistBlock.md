[Docs](../README.md) / [notion-types](../modules/notion_types.md) / GistBlock

# Interface: GistBlock

[notion-types](../modules/notion_types.md).GistBlock
...
- [alive](notion_types.GistBlock.md#alive)
- [content](notion_types.GistBlock.md#content)
- [created\_by\_id](notion_types.GistBlock.md#created_by_id)
- [created\_by\_table](notion_types.GistBlock.md#created_by_table)
- [created\_time](notion_types.GistBlock.md#created_time)
- [file\_ids](notion_types.GistBlock.md#file_ids)
- [format](notion_types.GistBlock.md#format)
- [id](notion_types.GistBlock.md#id)
- [last\_edited\_by\_id](notion_types.GistBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.GistBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.GistBlock.md#last_edited_time)
- [parent\_id](notion_types.GistBlock.md#parent_id)
- [parent\_table](notion_types.GistBlock.md#parent_table)
- [properties](notion_types.GistBlock.md#properties)
- [space\_id](notion_types.GistBlock.md#space_id)
- [type](notion_types.GistBlock.md#type)
- [version](notion_types.GistBlock.md#version)
...
[packages/notion-types/src/block.ts:280](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L280)
