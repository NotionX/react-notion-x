[Docs](../README.md) / [notion-types](../modules/notion_types.md) / MapsBlock

# Interface: MapsBlock

[notion-types](../modules/notion_types.md).MapsBlock
...
- [alive](notion_types.MapsBlock.md#alive)
- [content](notion_types.MapsBlock.md#content)
- [created\_by\_id](notion_types.MapsBlock.md#created_by_id)
- [created\_by\_table](notion_types.MapsBlock.md#created_by_table)
- [created\_time](notion_types.MapsBlock.md#created_time)
- [file\_ids](notion_types.MapsBlock.md#file_ids)
- [format](notion_types.MapsBlock.md#format)
- [id](notion_types.MapsBlock.md#id)
- [last\_edited\_by\_id](notion_types.MapsBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.MapsBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.MapsBlock.md#last_edited_time)
- [parent\_id](notion_types.MapsBlock.md#parent_id)
- [parent\_table](notion_types.MapsBlock.md#parent_table)
- [properties](notion_types.MapsBlock.md#properties)
- [space\_id](notion_types.MapsBlock.md#space_id)
- [type](notion_types.MapsBlock.md#type)
- [version](notion_types.MapsBlock.md#version)
...
[packages/notion-types/src/block.ts:308](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L308)
