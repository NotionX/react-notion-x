[Docs](../README.md) / [notion-types](../modules/notion_types.md) / ToggleBlock

# Interface: ToggleBlock

[notion-types](../modules/notion_types.md).ToggleBlock
...
- [alive](notion_types.ToggleBlock.md#alive)
- [content](notion_types.ToggleBlock.md#content)
- [created\_by\_id](notion_types.ToggleBlock.md#created_by_id)
- [created\_by\_table](notion_types.ToggleBlock.md#created_by_table)
- [created\_time](notion_types.ToggleBlock.md#created_time)
- [format](notion_types.ToggleBlock.md#format)
- [id](notion_types.ToggleBlock.md#id)
- [last\_edited\_by\_id](notion_types.ToggleBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.ToggleBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.ToggleBlock.md#last_edited_time)
- [parent\_id](notion_types.ToggleBlock.md#parent_id)
- [parent\_table](notion_types.ToggleBlock.md#parent_table)
- [properties](notion_types.ToggleBlock.md#properties)
- [space\_id](notion_types.ToggleBlock.md#space_id)
- [type](notion_types.ToggleBlock.md#type)
- [version](notion_types.ToggleBlock.md#version)
...
[packages/notion-types/src/block.ts:266](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L266)
...
[packages/notion-types/src/block.ts:265](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L265)
