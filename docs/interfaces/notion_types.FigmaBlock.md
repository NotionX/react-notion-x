[Docs](../README.md) / [notion-types](../modules/notion_types.md) / FigmaBlock

# Interface: FigmaBlock

[notion-types](../modules/notion_types.md).FigmaBlock
...
- [alive](notion_types.FigmaBlock.md#alive)
- [content](notion_types.FigmaBlock.md#content)
- [created\_by\_id](notion_types.FigmaBlock.md#created_by_id)
- [created\_by\_table](notion_types.FigmaBlock.md#created_by_table)
- [created\_time](notion_types.FigmaBlock.md#created_time)
- [file\_ids](notion_types.FigmaBlock.md#file_ids)
- [format](notion_types.FigmaBlock.md#format)
- [id](notion_types.FigmaBlock.md#id)
- [last\_edited\_by\_id](notion_types.FigmaBlock.md#last_edited_by_id)
- [last\_edited\_by\_table](notion_types.FigmaBlock.md#last_edited_by_table)
- [last\_edited\_time](notion_types.FigmaBlock.md#last_edited_time)
- [parent\_id](notion_types.FigmaBlock.md#parent_id)
- [parent\_table](notion_types.FigmaBlock.md#parent_table)
- [properties](notion_types.FigmaBlock.md#properties)
- [space\_id](notion_types.FigmaBlock.md#space_id)
- [type](notion_types.FigmaBlock.md#type)
- [version](notion_types.FigmaBlock.md#version)
...
[packages/notion-types/src/block.ts:288](https://github.com/ntcho/react-notion-x/blob/dbcf322/packages/notion-types/src/block.ts#L288)
