...
If you just want to publish a website using Notion, we highly recommend using [Super.so](https://s.super.so/x) — a hosted solution that takes care of all the details for you.
